...
/// 2. `[writable]` star_system_collection: [Metadata] 
...
///
/// Data:
/// - solar_system_object_type: [String] 
/// - name: [String] 
/// - rarity: [String] 
...
pub fn mint(
	...
	star_system_collection: &mut AccountPDA<Metadata>,
	funding: &AccountInfo,
    ...
    star_system_collection.data.solar_system_object_type = solar_system_object_type;
    star_system_collection.data.name = name;
    star_system_collection.data.rarity = rarity;
    star_system_collection.data.short_description = short_description;
    star_system_collection.data.mint = *mint.info.key;
    star_system_collection.data.assoc_account = Some(*assoc_token_account.key);
